...
void pass(bool *aux,pair<int, int> *equa,pair<int, int> *val);
...
int main() {
    ...
    estadosIniciais = (unsigned long int) pow(2, 30) - 1;
...
void pass (bool *aux, pair<int, int> *equa, pair<int, int> *val){
  ...
  // cout << equa[3].first << endl ;
  for (int i = 0; i < SIZE; i++) {
    //cout << "Pos: " << i << endl;
    int init = equa[i].first;
    // cout << "Init: " << init << endl;
    int last = equa[i].first + equa[i].second;
    // cout << "Last: " << last << endl;
    int count=0;
    for (int j =init; j<last-1;j++){
	  if(val[j].first == -2){
        count +=0*val[j].second;
	  }else if(val[j].first == -3){
		    count +=1*val[j].second;			
		}
		else{
      	count +=vet[val[j].first]*val[j].second;
      }
      //cout << "Value: " << val[j].first << endl;
      //cout << "vet: " << vet[val[j].first] << endl;

    	// cout << vet[val[j].first]*val[j].second << endl;
    }
    // cout << "teste "<<val[last-1].second << endl;
    aux[i] = count >= val[last-1].second ? 1 : 0;
  }
...
void runGNR(int inicio, int fim) {
  pair<int, int> equacoe[SIZE] = {make_pair(0,5), make_pair(5,4), make_pair(9,2), make_pair(11,5), make_pair(16,2), make_pair(18,2), make_pair(20,2), make_pair(22,3), make_pair(25,2), make_pair(27,4), make_pair(31,3), make_pair(34,2), make_pair(36,2), make_pair(38,2), make_pair(40,5), make_pair(45,2), make_pair(47,2), make_pair(49,2), make_pair(51,2), make_pair(53,3), make_pair(56,5), make_pair(61,4), make_pair(65,2), make_pair(67,2), make_pair(69,2), make_pair(71,3), make_pair(74,2), make_pair(76,2), make_pair(78,5), make_pair(83,3), make_pair(86,2), make_pair(88,2), make_pair(90,2), make_pair(92,4), make_pair(96,4), make_pair(100,3), make_pair(103,2), make_pair(105,3), make_pair(108,4) };

  pair<int, int> values[Tsize] = {make_pair(18,6), make_pair(35,-6), make_pair(28,-2), make_pair(25,-2), make_pair(-1,4), make_pair(25,2), make_pair(15,-6), make_pair(6,2), make_pair(-1,2), make_pair(36,2), make_pair(-1,2), make_pair(28,2), make_pair(17,-6), make_pair(0,-6), make_pair(32,2), make_pair(-1,2), make_pair(13,2), make_pair(-1,2), make_pair(24,2), make_pair(-1,2), make_pair(4,2), make_pair(-1,2), make_pair(34,2), make_pair(17,-2), make_pair(-1,2), make_pair(26,2), make_pair(-1,2), make_pair(16,2), make_pair(5,2), make_pair(22,-2), make_pair(-1,4), make_pair(2,2), make_pair(17,-2), make_pair(-1,2), make_pair(34,2), make_pair(-1,2), make_pair(18,2), make_pair(-1,2), make_pair(-2,2), make_pair(-1,2), make_pair(30,2), make_pair(34,6), make_pair(33,-6), make_pair(1,2), make_pair(-1,8), make_pair(36,2), make_pair(-1,2), make_pair(24,2), make_pair(-1,2), make_pair(9,2), make_pair(-1,2), make_pair(19,-2), make_pair(-1,0), make_pair(18,2), make_pair(21,-2), make_pair(-1,2), make_pair(3,2), make_pair(11,2), make_pair(35,2), make_pair(0,-2), make_pair(-1,6), make_pair(17,2), make_pair(12,-6), make_pair(31,2), make_pair(-1,2), make_pair(34,2), make_pair(-1,2), make_pair(-2,2), make_pair(-1,2), make_pair(-2,2), make_pair(-1,2), make_pair(28,2), make_pair(0,-2), make_pair(-1,2), make_pair(4,2), make_pair(-1,2), make_pair(28,2), make_pair(-1,2), make_pair(20,2), make_pair(0,-6), make_pair(1,2), make_pair(25,10), make_pair(-1,2), make_pair(17,2), make_pair(34,2), make_pair(-1,2), make_pair(10,2), make_pair(-1,2), make_pair(8,2), make_pair(-1,2), make_pair(38,2), make_pair(-1,2), make_pair(18,2), make_pair(7,-2), make_pair(34,-2), make_pair(-1,2), make_pair(30,2), make_pair(29,-6), make_pair(37,2), make_pair(-1,2), make_pair(14,2), make_pair(33,-2), make_pair(-1,2), make_pair(4,2), make_pair(-1,2), make_pair(27,2), make_pair(28,2), make_pair(-1,4), make_pair(20,2), make_pair(0,-6), make_pair(1,2), make_pair(-1,2)};
	...
	double tick, tock;
	tick = omp_get_wtime();
  // initialState(0, s0, s1, SIZE);
  // pass(s0,equacoe,values);
  // for (int i=0; i<SIZE; i++){
  //    cout << s0[i] << " ";
  // }
  // cout << endl;
