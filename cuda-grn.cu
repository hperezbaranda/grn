...
#include <stdio.h>
#include <list>
#define SIGN(x) (x > 0) ? (short)1 : (short)0
...
void pass(uint32 *S) {
    ...
    Sc[16]=Sc[12]+Sc[14]+1;
    Sc[17]=Sc[16]+Sc[78];
    Sc[18]=Sc[17]-Sc[7]-Sc[92]+1;
    Sc[19]=Sc[18]+Sc[34]+Sc[38];
    Sc[20]=Sc[13]+Sc[25]+Sc[33]-Sc[37]-Sc[43]+Sc[82];
    Sc[21]=Sc[18]+Sc[20]+Sc[20]-Sc[76]+Sc[95]-1;
    Sc[22]=Sc[13]+Sc[16];
    Sc[23]=Sc[22];
    Sc[24]=Sc[19]+Sc[23];
    Sc[25]=Sc[18]+Sc[19]-1;
    ...
    Sc[27]=Sc[26];
    Sc[28]=Sc[7]+1;
    Sc[29]=Sc[24]-Sc[25]-Sc[27]-Sc[33]+3;
    Sc[30]=Sc[28]+Sc[29]-1;
    Sc[31]=Sc[30]-Sc[43]+1;
    Sc[32]=Sc[10]+Sc[21]+Sc[84];
    Sc[33]=Sc[15]+Sc[25]+Sc[42]-Sc[72]-1;
    Sc[34]=Sc[4]+Sc[33]-Sc[36]-Sc[36]-Sc[37]+Sc[38]-Sc[43]-Sc[69]+2;
    Sc[35]=Sc[34];
    Sc[36]=Sc[4]-Sc[71]+1;
    Sc[37]=Sc[4]+Sc[71]+1;
    Sc[38]=Sc[8]+Sc[39]+Sc[6]-Sc[40]-Sc[63]-1;
    Sc[39]=Sc[21]+Sc[23]-Sc[34]+Sc[49]+Sc[70]+Sc[84]+Sc[5]-1;
    Sc[40]=Sc[34];
    Sc[41]=Sc[22]-Sc[23]-Sc[24]-Sc[25]+Sc[34]+Sc[43]+Sc[72]+1;
    Sc[42]=Sc[41]+1;
    Sc[43]=Sc[34]-Sc[44]-Sc[60]+Sc[88]+1;
    Sc[44]=Sc[21]+Sc[21]-Sc[43]-Sc[45]-Sc[46];
    Sc[45]=Sc[34]+Sc[43]-Sc[44]+Sc[68];
    Sc[46]=Sc[22]-Sc[24]-Sc[25]-Sc[34]+1;
    Sc[47]=Sc[43]-Sc[46]+1;
    Sc[48]=Sc[51]-Sc[52]-Sc[53]-Sc[54]-Sc[60]+2;
    Sc[49]=Sc[48]-Sc[48]-Sc[51]-Sc[52]+Sc[49]+1;
    Sc[50]=Sc[16]+Sc[38]+Sc[49]-3;
    Sc[51]=Sc[51]-Sc[48]-Sc[56]-Sc[58]-Sc[59]+Sc[80]+Sc[81];
    Sc[52]=Sc[43]-Sc[55]-Sc[56]-Sc[58]-Sc[59]+1;
    Sc[53]=Sc[21]-Sc[29]-Sc[29]+Sc[38]-Sc[58]-Sc[59]-Sc[64]-Sc[69]+Sc[70]+Sc[84]+Sc[5];
    Sc[54]=Sc[48]+Sc[49]-Sc[51]-Sc[58]-Sc[59];
    Sc[55]=Sc[51]-Sc[52]+Sc[56]+1;
    Sc[56]=Sc[52]-Sc[55];
    Sc[57]=Sc[51]+Sc[52]-Sc[55]+Sc[56]+Sc[57];
    Sc[58]=Sc[25]+Sc[34]-Sc[38]-Sc[51]-Sc[52]-Sc[53]+Sc[62]+1;
    Sc[59]=Sc[25]+Sc[34]-Sc[38]+Sc[43]+Sc[62]-Sc[78]+1;
    Sc[60]=Sc[25]+Sc[43]-Sc[50]-Sc[87]+1;
    Sc[61]=Sc[3]+Sc[8];
    Sc[62]=Sc[61]+Sc[85]-1;
    Sc[63]=Sc[61];
    Sc[64]=Sc[62]+Sc[85];
    ...
    Sc[70]=Sc[23]+Sc[68];
    Sc[71]=Sc[35]-Sc[83];
    Sc[72]=Sc[1]+Sc[11]+Sc[34]+Sc[87]+1;
    Sc[73]=Sc[25]+Sc[43]-Sc[44]+Sc[45]-Sc[47]+Sc[66]+Sc[67];
    Sc[74]=Sc[73];
    Sc[75]=Sc[66]+Sc[74];
    Sc[76]=Sc[21]-Sc[32]-Sc[95]+3;
    Sc[77]=Sc[25]+Sc[34]+Sc[38]-1;
    Sc[78]=Sc[12]+Sc[21]+Sc[25]+Sc[34]+Sc[38]-Sc[43]-Sc[62]-Sc[91]-4;
    Sc[79]=Sc[34]+Sc[38];
    Sc[80]=Sc[49]+Sc[54]-1;
    Sc[81]=Sc[55]+Sc[57]-1;
    Sc[82]=Sc[3];
    Sc[83]=Sc[21]+Sc[38]+Sc[59];
    Sc[84]=Sc[31]-Sc[82];
    Sc[85]=Sc[38]+1;
    Sc[86]=Sc[19]+Sc[33];
    Sc[87]=Sc[9];
    ...
    Sc[93]=Sc[34]+Sc[38]-1;
    Sc[94]=Sc[93];
    Sc[95]=Sc[21]-Sc[29]-Sc[43]+Sc[61]-1;
...
void findAttractor(uint32 *attractors, uint32 *transients, uint32 *periods, uint32_t numThreads){
    ...
    if(thread < numThreads){
	    ...
	    for (uint32 i = 0; i <= 9; ++i) {
          ...
          /*  S0[0]=1;      // garante as entradas fixas
            S0[1]=1;      // garante as entradas fixas
            S0[2]=0;      // garante as entradas fixas
            S0[3]=0;      // garante as entradas fixas
            S0[4]=0;      // garante as entradas fixas
            S0[5]=0;      // garante as entradas fixas
            S0[6]=1;      // garante as entradas fixas
            S0[7]=1;      // garante as entradas fixas
            S1[0]=1;      // garante as entradas fixas
            S1[1]=1;      // garante as entradas fixas
            S1[2]=0;      // garante as entradas fixas
            S1[3]=0;      // garante as entradas fixas
            S1[4]=0;      // garante as entradas fixas
            S1[5]=0;      // garante as entradas fixas
            S1[6]=1;      // garante as entradas fixas
            S1[7]=1;      // garante as entradas fixas*/

            attractors[i+thread*9];
...
int main() {
    ...
    findAttractor<<< 256,256 >>>(d_attractors, d_transients, d_periods, NUM_COPYS);
