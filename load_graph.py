...
if __name__ == '__main__':
	...
	parser.add_argument("ops", help="Number options 1= first time, 2= otherelse")
	...
	try:
		...
		if int(sys.argv[2]) == 0:
			...
			bool = []
			for i in line:
				# eq.append(i.strip().split(" = ")+[False,False])
			# update_eq = pd.DataFrame(eq,columns=['id','equation','fixed','observe'])
